    ...
    useEffect(() => {
        const fetchCourses = async () => {
            try {
                ...
                const response = await axios.post('/api/getCourses', { page: pageNumber, perPage: perPage });
        ...
        < div >
            {
                !loading && (
                    <main class="transition-all duration-300 ease-in-out flex w-full grow flex-col items-center">
                        <div class="flex w-full max-w-7xl flex-col px-6 py-8 md:py-12">

                            <div class="flex flex-col gap-2">
                                <h1 class="text-4xl font-black tracking-tighter text-gray-900 dark:text-gray-100">Welcome back, Alex!</h1>
                                        ...
                                        <Link key={course._id} href={`/courses/course?courseId=${course._id}`} class="flex transform flex-col overflow-hidden rounded-xl border border-gray-200 bg-white shadow-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-lg dark:border-gray-700 dark:bg-gray-800 dark:hover:shadow-primary/10">
                                            <div class="flex flex-col gap-4 p-4">
                                                <div class="flex flex-col gap-1">
                                                    <p class="text-base font-bold leading-tight text-gray-900 dark:text-gray-100 truncate">{course.title}</p>
                                                ...
                                                <div class="flex items-center justify-between text-sm text-gray-500 dark:text-gray-400">
                                                    ...
                                                    <div class="flex items-center gap-1">
                                                        ...
                                                        <span class="font-medium text-gray-700 dark:text-gray-300">{course.students}</span>
                                                    </div>
                                                </div>
                                            </div>
                                        </Link>
