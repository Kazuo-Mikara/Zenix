...
const FormCard = ({ formData, openCancelModal, openConfirmModal, handleSubmit, handleFormChange, validationErrors, formatTotalDuration, totalDurationMinutes, addModule, loading, handleModuleChange, removeModule }) => {
    return (
        <form onSubmit={handleSubmit}>
            ...
            <div className='flex justify-end items-end gap-2'>
                ...
                <button
                    type="submit"
                    disabled={loading}
                    className="mt-8  py-3 px-4 bg-primary-300 text-white font-bold rounded-lg  hover:cursor-pointer hover:bg-primary-500 transition duration-200 disabled:opacity-70 disabled:cursor-not-allowed shadow-xl flex items-center justify-center space-x-2"
                >
