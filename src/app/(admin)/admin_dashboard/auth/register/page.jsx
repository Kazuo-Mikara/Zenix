...
import { Shield, User, LockKeyhole, Mail } from 'lucide-react'
                ...
                <div className="flex flex-col max-w-md w-full gap-8">
                    <div>
                        ...
                        <div className="flex min-w-72 flex-col gap-3">
                            <p className="text-slate-900 dark:text-white text-4xl font-black leading-tight tracking-[-0.033em]">Admin Portal Register</p>
                            <p className="text-slate-500 dark:text-[#9dabb9] text-base font-normal leading-normal">Please enter your credentials to register.</p>
                        </div>
                    </div>
                    <div className="flex flex-col gap-5 w-full">
                        ...
                        <div className="flex flex-row justify-between">
                            <Link className="text-primary-300 text-sm font-medium leading-normal self-start underline-offset-2 hover:underline" href="/admin_dashboard/auth/login">Already have an account?</Link>
                        </div>
                    </div>
